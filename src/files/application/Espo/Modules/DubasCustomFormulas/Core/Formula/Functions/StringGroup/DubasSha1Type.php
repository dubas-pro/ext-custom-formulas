...
class DubasSha1Type extends \Espo\Core\Formula\Functions\Base
{
    public function process(\StdClass $item)
    {
        ...
        if (
            ...
            throw new Error('You have to provide parameter to DubasSha1 formula.');
        }
   
        return sha1($this->evaluate($item->value[0]));
    }
}
