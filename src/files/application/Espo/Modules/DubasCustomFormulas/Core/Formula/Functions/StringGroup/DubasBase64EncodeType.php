...
class DubasBase64EncodeType extends \Espo\Core\Formula\Functions\Base
{
    public function process(\StdClass $item)
    {
        ...
        if (
            ...
            throw new Error('You have to provide parameter to DubasBase64Encode formula.');
        }
   
        return base64_encode($this->evaluate($item->value[0]));
    }
}
