...
class DubasMd5Type extends \Espo\Core\Formula\Functions\Base
{
    public function process(\StdClass $item)
    {
        ...
        if (
            ...
            throw new Error('You have to provide parameter to DubasMd5 formula.');
        }
   
        return md5($this->evaluate($item->value[0]));
    }
}
