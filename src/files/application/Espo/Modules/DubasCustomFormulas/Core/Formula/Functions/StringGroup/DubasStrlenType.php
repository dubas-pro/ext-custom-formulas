...
class DubasStrlenType extends \Espo\Core\Formula\Functions\Base
{
    public function process(\StdClass $item)
    {
        ...
        if (
            ...
            throw new Error('You have to provide parameter to DubasStrlen formula.');
        }
   
        return strlen($this->evaluate($item->value[0]));
    }
}
