...
class DubasUrlDecodeType extends \Espo\Core\Formula\Functions\Base
{
    public function process(\StdClass $item)
    {
        ...
        if (
            ...
            throw new Error('You have to provide parameter to DubasUrlDecode formula.');
        }
   
        return urldecode($this->evaluate($item->value[0]));
    }
}
