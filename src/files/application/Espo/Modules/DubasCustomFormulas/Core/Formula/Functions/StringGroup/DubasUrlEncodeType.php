...
class DubasUrlEncodeType extends \Espo\Core\Formula\Functions\Base
{
    public function process(\StdClass $item)
    {
        ...
        if (
            ...
            throw new Error('You have to provide parameter to DubasUrlEncode formula.');
        }
   
        return urlencode($this->evaluate($item->value[0]));
    }
}
